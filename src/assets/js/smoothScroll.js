...
*/
{
    ...
    class SmoothScroll {
        constructor() {
            // the <main> element
            this.DOM = {main: document.querySelector('#app')};
            // the scrollable element
            // we translate this element when scrolling (y-axis)
            this.DOM.scrollable = this.DOM.main.querySelector('div.layout-wrapper');
        ...
        layout() {
            ...
            this.DOM.header.style.transform = `translate3d(0,${1*this.renderedStyles.translationY.previous}px,0)`;
        }
        setSize() {
    ...
    window.getPageYScroll = getPageYScroll;
}